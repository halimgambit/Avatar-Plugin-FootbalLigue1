...
exports.default = function (state) {
	...
	return new Promise(function (resolve, reject) {
		...
		for (var rule in Config.modules.FootbalLigue1.rules) {
			var match = (0, _helpers.syntax)(state.sentence, Config.modules.FootbalLigue1.rules[rule]); 
			if (match) break;
		}
		...
		setTimeout(function(){ 
			if (state.debug) info('Action FootbalLigue1');
			
			state.action = {
				module: 'FootbalLigue1',
				command: rule,
				room: room,
